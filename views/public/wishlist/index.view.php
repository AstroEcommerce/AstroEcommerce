                ...
                <?php foreach ($wishlistItems as $item) : ?>
                    <!-- <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4"> -->
                        <div class="mx-2 card" onclick="location.assign('./products/<?php echo $item['id']; ?>')">
                            ...
                            <div class="action">
                                <div class="price">
                                    <span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-baseline"><path d="M4 20h16"/><path d="m6 16 6-12 6 12"/><path d="M8 12h8"/></svg> <?php echo $item['price']; ?></span>
                                </div>
