...
<div class="container d-flex flex-row create">
    ...
    <div class="feature-card">
      ...
      <a href="#about" class="btn-gradient">Get Started</a>
      </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            new Splide('#image-slider', {
                ...
                breakpoints: { 
                    ...
                    1024: { perPage: 2 , gap: '40px' , padding: '30px' }, // Show 2 slides on smaller screens
                    768: { perPage: 2 , perMove: 1 , gap: '30px' , padding: '20px' },  // Show 1 slide on mobile
                    568: { perPage: 1 , perMove: 1 , gap: '40px' , padding: '80px' },  // Show 1 slide on mobile
            ...
            new Splide('#image-slider-new', {
                ...
                breakpoints: { 
                    ...
                    768: { perPage: 2 , perMove: 1 , gap: '30px' , padding: '20px' },  // Show 1 slide on mobile
                    568: { perPage: 1 , perMove: 1 , gap: '40px' , padding: '80px' },  // Show 1 slide on mobile
                    400: { perPage: 1 , perMove: 1 , gap: '40px' , padding: '60px' }  // Show 1 slide on mobile
                }
            }).mount();
        });
